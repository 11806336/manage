...
//todo:添加箭头指向效果
            $sub.parent().find(".dropdown-toggle").find(".arrow").removeClass("fa-angle-right").addClass("fa-angle-down");
...
//todo:添加箭头指向效果
             $sub.parent().find(".dropdown-toggle").find(".arrow").removeClass("fa-angle-down").addClass("fa-angle-right");
			sub.offsetHeight;
