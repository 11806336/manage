...
<div id="main">
    <div class="control-group form-inline">
        <div class="controls sel_time">
            ...
            <input class="form-control" type="text" id="dateStart" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="dateStart" readonly="readonly" style="background-color: #fff;cursor:pointer">
            <label for="dateEnd" style="margin-left: 10px;">结束日期:</label>
            <input class="form-control" type="text" id="dateEnd" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="dateEnd" readonly="readonly" style="background-color: #fff;cursor:pointer">
            <input type="button" value="查询" class="btn" id="searchBtnIdata" style="margin-left: 20px;" onclick="searchBtnIdata()">
...
<script>
    ...
    var dataColumns = [
        ...
        {field: 'stockOrderId', title: '委托ID'},
        {field: 'contractId', title: '合同编号'},
        {field: 'stockOrderStatus', title: '委托状态'},
        {field: 'stockOrderDate', title: '委托日期'},
        {field: 'knockAvgPrice', title: '成交均价'},
        {field: 'cancelQty', title: '已撤数量'},
    ...
    function searchBtnIdata() {
        ...
        $table.bootstrapTable('refresh', {url: '${basePath}/account/tradeOrder?dateStart=' + dateStart + "&dateEnd=" + dateEnd });
    }
</script>
</body>
</html>