...
<div id="main">
    <div class="control-group form-inline mt10 mb10">
        <div class="controls">
            ...
            <input type="button" value="上一日" class="btn" name="prev_day" id="prev_day" style="margin-left: 10px;">
            <input type="button" value="下一日" class="btn" name="next_day" id="next_day" style="margin-left: 10px;">
...
<script>
    ...
    var dataColumns = [
        ...
        {field: 'stockHoldingId', title: '股票持仓ID'},
        {field: 'stockAccountId', title: '股票账号ID'},
        {field: 'stockId', title: '股票ID'},
        {field: 'positionHolding', title: '当前持仓'},
        {field: 'positionDate', title: '持仓日期'},
        {field: 'positionCost', title: '持仓成本'},
        {field: 'costValue', title: '成本价'},
        {field: 'singleCostValue', title: '单股成本价'},
        {field: 'profitLoss', title: '盈亏'},
    ...
    function searchBtnIdata() {
        var positionDate = $("#positionDate").val();
        $table.bootstrapTable('refresh', {url: '${basePath}/account/stockHolding?positionDate=' + positionDate});
    }
</script>
</body>
</html>