...
<section style="height:100%;">
    <div class="content_tab" style="background-color: #333;">
        ...
        <ul id="tabs" class="tabs">
            ...
            <li id="tab_setAccountInfo" data-index="position" class="">
    ...
    <div class="content_main">
        ...
        <div id="iframe_position" class="iframe">
            <iframe class="tab_iframe" src="/account/details/tab/query_position/${amsProduct.productId}" width="100%" frameborder="0" scrolling="auto" onload="changeFrameHeight(this)"></iframe>
        </div>
        <div id="iframe_entrust" class="iframe">
            <iframe class="tab_iframe" src="/account/details/tab/query_trade_order/${amsProduct.productId}" width="100%" frameborder="0" scrolling="auto" onload="changeFrameHeight(this)"></iframe>
        </div>
        <div id="iframe_success_bargain" class="iframe">
            <iframe class="tab_iframe" src="/account/details/tab/query_trade_order_feed/${amsProduct.productId}" width="100%" frameborder="0" scrolling="auto" onload="changeFrameHeight(this)"></iframe>
        </div>
