...
public class RskBlackwhiteListServiceImpl  implements RskBlackwhiteListService {
        ...
        public List<Map<String, Object>> selectBlackWhite(Map map){
            return rskBlackwhiteListMapper.selectBlackWhite(map);
        }

        @Override
        public int selectBlackWhiteCount(Map map) {
            return rskBlackwhiteListMapper.selectBlackWhiteCount(map);
        }
        @Override
        ...
        */
        ...
        public int deleteByIsBlack(Integer isBlack){
            try {
                DynamicDataSource.setDataSource(DataSourceEnum.MASTER.getName());
                return rskBlackwhiteListMapper.deleteByIsBlack(isBlack);
            } catch (Exception e) {
                e.printStackTrace();
            }
            DynamicDataSource.clearDataSource();
