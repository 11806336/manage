...
public class AmsProductBasicController extends BaseController {
    ...
    public Object  positionList(
        ...
        List<Map> rows = amsProductUnitExtService.selectAmsProductUnitExtWithDetail(params);
        long total = amsProductUnitExtService.selectAmsProductUnitExtWithDetailCount(params);
        Map<String, Object> result = new HashMap<String, Object>();
        result.put("total", total);
        result.put("rows", rows);
        return result;
    ...
    public Object AmsKnockList(
        ...
        Map<String, Object> params = Maps.newHashMap();
        if (org.apache.commons.lang3.StringUtils.isNotEmpty(dateBegin)) {
            Long date_begin = Long.parseLong(dateBegin.replaceAll("-",""));
            params.put("dateBegin",date_begin);
        }
        if (org.apache.commons.lang3.StringUtils.isNotEmpty(dateEnd)) {
...
//        params.put("offset", offset);
//        params.put("limit", limit);
//        List<Map> rows = amsProductUnitService.selectTradeAccoutWithDetail(params);
//        long total = amsProductUnitService.selectTradeAccoutWithDetailCount(params);
//        Map<String, Object> result = new HashMap<String, Object>();
//        result.put("total", total);
//        result.put("rows", rows);
//        return result;
