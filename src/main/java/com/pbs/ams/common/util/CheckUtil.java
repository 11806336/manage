...
import com.pbs.ams.web.service.impl.AmsProductUnitServiceImpl;
...
public class CheckUtil {
    ...
    private static final AmsProductUnitServiceImpl amsProductUnitService = SpringContextUtil.getBean("amsProductUnitServiceImpl", AmsProductUnitServiceImpl.class);
    ...
    private static boolean checkAccount(boolean result, Long id) {
        ...
        if (amsProductUnit.getCompanyId() != null) {
            result = false;
        }
        return result;
    }
